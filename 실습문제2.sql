...
-- WHERE PROPESSOR_NAME NOT LIKE '___';

-- 3. *
SELECT PROFESSOR_NAME 교수이름, 
				ROUND( MONTHS_BETWEEN( SYSDATE, ADD_MONTHS( TO_DATE(SUBSTR(PROFESSOR_SSN, 1, 6) , 'YYMMDD'), -1200)) / 12) 나이
		 	--ROUND((MONTHS_BETWEEN(SYSDATE, TO_DATE('19' || SUBSTR(PROFESSOR_SSN, 1, 6)))) / 12) 나이
FROM TB_PROFESSOR
...
-- 6.
SELECT TO_CHAR(TO_DATE('201225', 'YYMMDD'), 'DY') || '요일'
FROM DUAL;
