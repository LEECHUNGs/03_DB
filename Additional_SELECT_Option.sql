...
-- 3.
SELECT STUDENT_NAME "학생이름", STUDENT_NO , STUDENT_ADDRESS 
FROM TB_STUDENT 
...
-- 9.
SELECT C.CLASS_NAME, P.PROFESSOR_NAME, D.DEPARTMENT_NO 
FROM TB_CLASS_PROFESSOR CP
JOIN TB_CLASS C USING (CLASS_NO)
...
-- 10.
SELECT STUDENT_NO AS "학번", STUDENT_NAME,
...
FROM TB_STUDENT
JOIN TB_DEPARTMENT USING (DEPARTMENT_NO)
LEFT JOIN TB_PROFESSOR P ON (COACH_PROFESSOR_NO = P.PROFESSOR_NO)
