...
INSERT INTO "BOARD_IMG" VALUES(
	SEQ_IMG_NO.NEXTVAL, '/images/board/', '원본1.jpg', 'test1.jpg', 0, 1973
);

INSERT INTO "BOARD_IMG" VALUES(
	SEQ_IMG_NO.NEXTVAL, '/images/board/', '원본2.jpg', 'test2.jpg', 1, 1973
);

INSERT INTO "BOARD_IMG" VALUES(
	SEQ_IMG_NO.NEXTVAL, '/images/board/', '원본3.jpg', 'test3.jpg', 2, 1973
);

INSERT INTO "BOARD_IMG" VALUES(
	SEQ_IMG_NO.NEXTVAL, '/images/board/', '원본4.jpg', 'test4.jpg', 3, 1973
);

INSERT INTO "BOARD_IMG" VALUES(
	SEQ_IMG_NO.NEXTVAL, '/images/board/', '원본5.jpg', 'test5.jpg', 4, 1973
);
...
SELECT BOARD_NO, BOARD_TITLE, BOARD_CONTENT, BOARD_CODE, READ_COUNT,
	...
	(SELECT COUNT(*)
	 FROM "BOARD_LIKE"
	 WHERE BOARD_NO = 1973) LIKE_COUNT,
...
(
	SELECT NEXT_IMG_NO(), '경로1', '워본1', '변경1', 1, 2001 FROM DUAL
	UNION
	SELECT NEXT_IMG_NO(), '경로1', '워본1', '변경1', 2, 2001 FROM DUAL
	UNION
	SELECT NEXT_IMG_NO(), '경로1', '워본1', '변경1', 3, 2001 FROM DUAL
);
...
BOARD_TITLE = ?, 
BOARD_CONTENT = ?
WHERE BOARD_CODE = ? AND BOARD_NO = ? AND MEMBER_NO = ?;
...
UPDATE "COMMENT" SET
	COMMENT_CONTENT = '부모 2의 자식 1'
WHERE COMMENT_NO = 2006;

UPDATE "COMMENT" SET
	COMMENT_CONTENT = '부모 2의 자식 1의 자식'
WHERE COMMENT_NO = 2007;
...
/* 계층형 쿼리 */
-- PARENT_COMMENT_NO 값이 NULL 인 행을 부모 (LV.1)
START WITH PARENT_COMMENT_NO IS NULL
...
WHERE COMMENT_DEL_FL = 'N' -- 현재 댓글이 삭제되지 않았을때
