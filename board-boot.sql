...
CREATE USER spring_lcs IDENTIFIED BY spring1234;

GRANT CONNECT, RESOURCE TO spring_lcs;

ALTER USER spring_lcs DEFAULT TABLESPACE SYSTEM QUOTA UNLIMITED ON SYSTEM;
...
UPDATE "MEMBER" SET 
MEMBER_PW = '$2a$10$9Oz3lXTN93ApPl9mHuXLdObDB.amYBRNbpD6bCav4QwdaY3eooQ7G'
WHERE MEMBER_NO = 1;
...
UPDATE "MEMBER" SET
	 		MEMBER_PW = '$2a$10$i8u8FSIZHDLb0Nv7A8/Zl.AKkwP56uqT4nYU4R4xBBKzdgHpbm84C'
WHERE MEMBER_NO = 2;
